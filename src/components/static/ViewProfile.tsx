...
const ViewProfile = () => {
  return (
    <>
      <div className="text-[13px] min-h-[200px] ">
        <div>
          <p>Name: </p>
        ...
        <div>
          <p>Full Name: </p>
          <span className="text-slate-400">full name of user</span>
        </div>
        <br />
        <div>
          <p>Email: </p>
          <span className="text-slate-400">email address of user</span>
        </div>
        <br />
        <div>
          <p>Company Details: </p>
          <span className="text-slate-400">
            Role: company role; Location: company location; brand: company name
          </span>
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <span className="text-slate-400">
            ...
            elit. Culpa ipsum placeat nobis officiis magnam soluta dolorem
